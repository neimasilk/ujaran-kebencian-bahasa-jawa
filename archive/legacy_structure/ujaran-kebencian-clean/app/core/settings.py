...
class Settings(BaseSettings):
    ...
    # Data Configuration  
    data_dir: str = "./data"
    raw_dataset_path: str = "./data/raw/raw-dataset.csv"
    ...
    # Label mapping for API responses
    LABEL_MAPPING: dict = {
...
base_dir = Path(__file__).parent.parent.parent  # Points to project root directory
...
model_path = base_dir / settings.model_save_path
checkpoint_path = base_dir / settings.checkpoint_dir
