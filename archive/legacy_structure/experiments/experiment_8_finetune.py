"""
EXPERIMENT 8B: Fine-tune Custom Javanese BERT v3
===================================================

Fine-tune Custom Javanese BERT v3 (hasil DAPT) untuk hate speech detection.

Expected: +1-2% improvement dari baseline 81.38%
...
class FinetuneConfig:
    """Configuration untuk fine-tuning Custom BERT v3"""
    ...
    # Output paths
    output_dir: str = "results/experiment_8b_finetune"
    model_output_dir: str = "models/experiment_8b_finetune"
    ...
    # Label smoothing (best from exp 6A)
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("EXPERIMENT 8B: Fine-tune Custom Javanese BERT v3")
    logger.info("=" * 60)
    ...
    logger.info(f"Loading Custom BERT v3 from: {config.model_path}")
    ...
    # Save results
    results = {
        'experiment_name': 'Experiment 8B: Custom Javanese BERT v3 Fine-tuning',
    ...
    baseline_f1 = 0.8138  # From Experiment 6A
    improvement = (test_f1_macro - baseline_f1) * 100

    logger.info("\n" + "=" * 60)
    logger.info("SUMMARY")
    logger.info("=" * 60)
    logger.info(f"Baseline (IndoBERT):       {baseline_f1 * 100:.2f}%")
    logger.info(f"Custom Javanese BERT v3:    {test_f1_macro * 100:.2f}%")
